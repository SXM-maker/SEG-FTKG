...
from transformers import BertTokenizer, BertModel, GPT2Tokenizer, GPT2Model, AutoTokenizer
...
class DataPreprocessor:
    ...
    def generate_historical_triplets(self):
        ...
        """
        # //defaultdict(<class 'list'>, {0: [[19, 6, 151], [2233, 2, 57], [182, 23, 112], [22, 17, 21], [3, 8, 742], [507, 2, 55], [154, 25, 56], [100, 83, 18], [1110, 2, 31], [141, 29, 7], [6, 5, 22]]
...
def get_historical_embeddings(dataset, num_k, plm='bert-large-cased', model_type='bert', batch_size=32, gpu=-1, save=False):
    ...
    paths = preprocessor.get_paths()
             # //{'ent_ent_his_emb_path': '/home/shxm/DSEP-main/data/ICEWS14/text_emb/bert-base-cased/ent_ent_his_emb_num7.pt', 'ent_rel_his_emb_path': '/home/shxm/DSEP-main/data/ICEWS14/text_emb/bert-base-cased/ent_rel_his_emb_num7.pt', 'entities_emb_path': '/home/shxm/DSEP-main/data/ICEWS14/text_emb/bert-base-cased/entities_emb.pt', 'path': '/home/shxm/DSEP-main/data/ICEWS14/text_emb/bert-base-cased', 'relations_emb_path': '/home/shxm/DSEP-main/data/ICEWS14/text_emb/bert-base-cased/relations_emb.pt'}
